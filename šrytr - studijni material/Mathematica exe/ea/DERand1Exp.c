...
void DERand1Exp P(( double,double, int, int, int,doublep_nt));

void DERand1Exp( double F,double CR, int NP, int D, int Generations,doublep_nt list)
{
	int i,j,V1,V2,V3,Flag;
   double	ckl1;
