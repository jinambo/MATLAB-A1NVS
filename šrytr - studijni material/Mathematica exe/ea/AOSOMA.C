...
void AOSoma P(( double,double,double,int,int,int,double, doublep_nt));

void AOSoma( double Mass,double Step,double PRT, int NP, int D, int Migrations,double AcceptedError,doublep_nt list2 )
{
   double	ckl1;
	int 		i,j;//l,n,neval;
